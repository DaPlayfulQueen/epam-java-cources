...
public interface Task038 {
     ...
     * Path must contain source and target node and ordered from source to target
     * @param graph graph instance
     * @param startId is id of source node
     * @param endId is id of target node
     * @return  collection of nodes from source to target with minimum possible
     * sum of edge weights. If path doesn't exist, return empty collection
     */
